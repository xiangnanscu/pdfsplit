...
第二章 平面解析几何:
  ...
  2.5 椭圆及其方程:
    ...
    2.5.2 椭圆的几何性质:
      - 1. 椭圆的几何性质
      - 2. 用信息技术作出椭圆以及研究椭圆的性质
  2.6 双曲线及其方程:
    2.6.1 双曲线的标准方程: []
    2.6.2 双曲线的几何性质:
      - 1. 双曲线的几何性质
      - 2. 用信息技术作出双曲线以及研究双曲线的性质
  2.7 抛物线及其方程:
    2.7.1 抛物线的标准方程: []
    2.7.2 抛物线的几何性质:
      - 1. 抛物线的几何性质
      - 2. 用信息技术作出抛物线以及研究抛物线的性质
  2.8 直线与圆锥曲线的位置关系: []
第三章 排列、组合与二项式定理:
  3.1 排列与组合:
    3.1.1 基本计数原理:
...
\`\`\`json
{
  ...
  "analysis_md": "String (考点溯源与思路分析，突破口，使用Markdown)",
  "pitfalls_md": "String (避坑指南，指出易错点，使用Markdown)"
}
\`\`\`

# 其他说明
\`tags\` 数组中的内容必须严格完全匹配【知识点目录】中的文本，不要自己创造知识点名称。如果题目考察了多个知识点，请在数组中列出所有。如果题目存在【知识点目录】之外的知识点，请打上标签“超纲知识”。
`;