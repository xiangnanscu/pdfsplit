      ...
      {isError ? (
        ...
        <div className="text-center w-full animate-fade-in">
          <div className="bg-orange-50 text-orange-600 p-8 rounded-3xl mb-4 border border-orange-100">
            ...
            <p className="font-medium opacity-80 mb-2">Progress saved to local storage.</p>
            <p className="text-sm font-bold opacity-60">Completed: {completedCount} / {total} pages</p>
          </div>
          
          {onResume && (
            <button 
              onClick={onResume}
              className="mt-4 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-black uppercase tracking-wider transition-all shadow-xl shadow-blue-200 active:scale-95 flex items-center gap-3 mx-auto"
            >
