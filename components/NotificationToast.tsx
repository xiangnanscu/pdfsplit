...
const ToastItem: React.FC<{
  ...
  return (
    <div className="bg-white rounded-xl shadow-2xl shadow-slate-400/20 border border-slate-200 p-4 w-80 pointer-events-auto animate-[fade-in_0.3s_ease-out] flex items-start gap-3 relative overflow-hidden group">
      <div
        className={`absolute top-0 left-0 w-1 h-full ${notification.type === "success" ? "bg-green-500" : "bg-red-500"}`}
      ></div>
      ...
      <div
        className={`mt-0.5 w-6 h-6 rounded-full flex items-center justify-center shrink-0 ${notification.type === "success" ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`}
      >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-slate-500 font-bold mb-3 break-words leading-relaxed">
